...
//       INGENICO                                INGEDEV 7                   
//============================================================================
//       Telium_File_t  GOAL.C                              (Copyright INGENICO 2012)
//============================================================================
...
int GoalGetKey(T_GL_HWIDGET hWindow, T_GL_HGRAPHIC_LIB hGraphicLib, bool bShortcut, ulong ulTimeOut, bool bClear)
{
    ...
    // ***************
#ifndef __TELIUM3__
	Telium_File_t *hKbd=NULL;  // Handle peripheral Keyboard
	...
	if (bClear)
	{
		...
		if(hKbd)
			Telium_Reset_buf(hKbd, _receive_id);                     // Yes, reset "keyboard" FIFO
